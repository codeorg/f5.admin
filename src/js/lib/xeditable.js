...
.value('editableOptions', {
  ...
  theme: 'default',
  /**
   * Whether to show buttons for singleScaler editalbe element.
  ...
  buttons: 'right',
  /**
   * Default value for `blur` attribute of singleScaler editable element.
  ...
  function(editableDirectiveFactory) {
    return editableDirectiveFactory({
      ...
      addListeners: function() {
        ...
        if (self.singleScaler && self.buttons !== 'no') {
          self.autosubmit();
        }
      },
      autosubmit: function() {
  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
    ...
    self.init = function(single) {
      ...
      */
      ...
      // settings for singleScaler and non-singleScaler
      if (!self.single) {
        // hide buttons for non-singleScaler
        self.buttons = 'no';
      } else {
...
- detect form for editable element. Form may be one of three types:
  1. autogenerated form (for singleScaler editable elements)
  ...
  return function(overwrites) {
    return {
      ...
      link: function(scope, elem, attrs, ctrl) {
        ...
        // or it's singleScaler element who's form will be generated automatically
        // By default consider singleScaler element without any linked form.ß
        var hasForm = false;
      ...
      compile: function() {
        return {
          pre: function(scope, elem, attrs, ctrl) {
            ...
            //this is required only for singleScaler editor form that is created and removed
